      ...
      try {
        ...
        if (isBatch) {
          ...
          pathToSave = await save({
            ...
            defaultPath: `AICompress-${compressedFile?.fileNameToDisplay ?? fileName ?? ''}`,
          })
        }
          ...
          if (isBatch) {
            ...
            for (let i = 0; i < media.length; i++) {
              ...
              if (mediaFile.compressedFile?.pathRaw) {
                ...
                const destinationPath = `${directory}/AICompress-${mediaFile?.compressedFile?.fileNameToDisplay || mediaFile?.fileName}`
