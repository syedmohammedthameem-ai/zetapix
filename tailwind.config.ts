...
const config: Config = {
  ...
  content: [
    ...
    // HeroUI components. pnpm does not hoist, so the package sits under
    // .pnpm/<name>@<version>/node_modules/. Without the second glob none of
    // HeroUI's internal utility classes are generated and every component
    // renders unstyled: labels land on top of inputs, sliders lose their
    // track, buttons lose their background.
