                    ...
                    if let Some(stdout) = proc.take_stdout() {
                        ...
                        for line_res in reader.lines() {
                            if let Ok(line) = line_res {
                                // The line break has to survive. JSON does not
                                // care, but any line-oriented output does, and
                                // dropping it turns a listing into one line.
