...
impl ImageCompressor {
    ...
    async fn apply_spatial_transformations(
        ...
        let filter_complex = build_ffmpeg_filters(transform_history, dimensions, true);
