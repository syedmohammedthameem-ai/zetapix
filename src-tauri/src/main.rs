...
use tauri_commands::{
    ...
    encoders::get_available_chips,
    feasibility::estimate_compression,
...
// "Open with AICompress" triggers `application:openURLs` before app setup is complete
